	...
	<body>
		...
		<div id="show-patient" class="content scaffold-show" role="main">
			...
			<ol class="property-list patient">
				...
				<g:if test="${patientInstance?.pin}">
				<li class="fieldcontain">
					<span id="pin-label" class="property-label"><g:message code="patient.pin.label" default="Pin" /></span>
					
						<span class="property-value" aria-labelledby="pin-label"><g:fieldValue bean="${patientInstance}" field="pin"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${patientInstance?.ssn}">
				<li class="fieldcontain">
					<span id="ssn-label" class="property-label"><g:message code="patient.ssn.label" default="Ssn" /></span>
					
						<span class="property-value" aria-labelledby="ssn-label"><g:fieldValue bean="${patientInstance}" field="ssn"/></span>
